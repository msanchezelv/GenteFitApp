...
def crear_monitor_en_odoo(monitores):
    ...
    for monitor in monitores:
        try:
            # Verificar si 'id_actividad' está en el monitor y tiene un valor
            id_actividad = monitor.get('id_actividad', None)
            # Si id_actividad es None, usar un valor vacío o el valor por defecto
