...
namespace GenteFitApp.Controlador
{
    ...
    {
        private string connectionString = @"Data Source=DESKTOP-0P1J4U5\SQLEXPRESS;Initial Catalog=GenteFit;Integrated Security=True"; // Cambia esta cadena de conexión según sea necesario
